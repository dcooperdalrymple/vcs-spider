...
# Help message
    ...
    print "  sprite_image.py -name [ADDRESSNAME] -in [FILENAME] -out [FILENAME] -reverse [0/1]"
    print "\nAccepts png/jpg input and .asm output is preferred."
    raise SystemExit

if len(sys.argv) == 9 and sys.argv[1] == '-name' and sys.argv[3] == '-in' and sys.argv[5] == '-out' and sys.argv[7] == '-reverse':

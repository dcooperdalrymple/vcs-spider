...
#endif
#if SYSTEM = PAL
SWATTER_HOLD_TIME       = 50
#endif
SWATTER_ACTIVE_TIME     = #SWATTER_HOLD_TIME/2
...
SWATTER_HOLD_SAMPLE_LEN = 3 ; #SWATTER_HOLD_TIME/(SWATTER_HOLD_SAMPLE_F_MIN-SWATTER_HOLD_SAMPLE_F_MAX) ; Time between each frequency

#if SYSTEM = NTSC
SWATTER_ACTIVE_SAMPLE_LEN   = 20
#endif
#if SYSTEM = PAL
SWATTER_ACTIVE_SAMPLE_LEN   = 17
#endif
